...
다른 서버를 검사하려면 `QA_BASE_URL` 환경 변수를 지정합니다. 현재 단위 테스트 38개를 통과했습니다. 직전 전체 브라우저 테스트 20개 통과 후, 차량 속도 변경에 관련된 7개를 다시 통과했습니다. 검사 범위와 실행 환경은 [검증 기록](docs/verification.md)에 정리했습니다.
